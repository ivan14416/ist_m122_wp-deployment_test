...
* Added - Free vs Pro tab on admin welcome page
* Added - Documentation link on admin welcome page

= 1.3.8 =
Release date - March, 24 - 2021

* Added - Welcome page on admin section
...
* Fixed - Keyboard navigation on mobile devices

= 1.3.4 =
Release date - January, 08 - 2021

* Tested with WordPress 5.6
* Updated - Theme notice
...
* Optimized - Keyboard navigation inside the modal menu and search menu
* Edit - Code optimized
...
* Fixed - Keyboard navigation issue inside the modal menu

= 1.2.4 =
Release date - June, 09 - 2020

* Fixed - Access on header search form from keyboard navigation
...
* Added - Option to disable the post category on homepage slideshow
* Added - Option to disable the post details on homepage slideshow
* Edit - Code optimized
* Updated - Italian translation
...
* Added - Option to disable the sticky header
* Added - Option to change the WooCommerce icon
* Updated - Italian translation
...
* Fixed - Text color of logo on focus state
* Fixed - Background color of link posts on focus state

= 1.1.6 =
Release date - December, 26 - 2019

* Fixed - Child pages issue on navigation menu
...
* Changed - Default slideshow limit value
* Edit - Code optimized
...
* Updated - WooCommerce templates
* Fixed - Coupon input field on cart page
